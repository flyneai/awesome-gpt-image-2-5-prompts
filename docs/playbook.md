...
以下路线原由 FLAQ 团队编写，现由 [Flyne AI](https://flyne.ai) 维护。本页将继承配方串成可操作的创作路线；全库另含 Flyne 新增配方，共106条。每条路线说明如何准备素材、选配方、检查结果，再继续下一步。路线组合不重复计入配方数量，也不代表这些玩法是2.5独占功能。

多图流程需使用支持相应输入数量的工具；免费入口限制见[逐条输入说明](recipe-access.md)。
...
[![商品母版示例](../assets/previews/tideline-lamp.jpg)](../assets/images/tideline-lamp.png)

[![第二轮保留配色并替换标题](../assets/previews/tideline-lamp-copy.jpg)](../assets/images/tideline-lamp-copy.png)
...
[![日英双语面包店海报示例](../assets/previews/komorebi-bakery.jpg)](../assets/images/komorebi-bakery.png)
...
[![原创阅读室概念示例](../assets/previews/reading-room.jpg)](../assets/images/reading-room.png)
...
[![纸月亮故事示例，第三格需要连续性修正](../assets/previews/paper-moon-story.jpg)](../assets/images/paper-moon-story.png)
...
源库维护者记录：当时提供的微信文章返回验证页，未核对正文。以上路线由 FLAQ 团队根据原库配方组织，Flyne 版继承并维护，不宣称来自该文章。来源与导入版本见[维护记录](upstream.md)。
