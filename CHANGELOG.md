...
- Adapted all 16 entry pages and product links for Flyne; replaced the brand cover.
- Added three bilingual, X-inspired prompts and three new generated examples: 106 recipes and 142 PNGs total.
- Added source-linked video demonstrations with explicit image/video model roles.
- Added reproducible video index and continuous validation.

## Imported upstream changelog
