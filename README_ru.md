# Промпты для GPT Image 2.5 — Flyne AI

<!-- BEGIN FLYNE ENTRY -->
**[GPT Image 2.5 бесплатно · Без регистрации](https://flyne.ai/free-gpt-image-2-5/)**

Одно референсное изображение; до 2 000 символов. Проверьте требования каждого рецепта. Бесплатно и без регистрации — заявление сайта; генерация без входа не проверена. [→](docs/flyne-access.md)
...
Проверьте и сохраните первое изображение. Прикрепите его и выполните эту правку отдельно.
...
## Расширенные функции: проверьте стоимость в кредитах перед генерацией

[GPT Image 2.5 — Flare / Sunburst](https://flyne.ai/model/gpt-image-2-5/)

[Бесплатно и без регистрации — заявление сайта; генерация без входа не проверена.](docs/flyne-access.md)

## Статус примеров

У исходного рецепта есть сгенерированный пример. Изображение и замечания доступны по ссылке ниже; это не проверка всех последующих правок. [L012](prompts/11-multilingual.md#l012).

Изображения созданы инструментом Codex без известного ID модели; это не проверенный тест Flare / Sunburst.
